...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1921543556636699937L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.microservice.user_service.event\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public UserCreatedEvent(java.lang.CharSequence name, java.lang.CharSequence email) {
    this.name = name;
    this.email = email;
  }
   ...
   */
  public static com.microservice.user_service.event.UserCreatedEvent.Builder newBuilder() {
    return new com.microservice.user_service.event.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.microservice.user_service.event.UserCreatedEvent.Builder newBuilder(com.microservice.user_service.event.UserCreatedEvent.Builder other) {
    if (other == null) {
      return new com.microservice.user_service.event.UserCreatedEvent.Builder();
    } else {
      return new com.microservice.user_service.event.UserCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.microservice.user_service.event.UserCreatedEvent.Builder newBuilder(com.microservice.user_service.event.UserCreatedEvent other) {
    if (other == null) {
      return new com.microservice.user_service.event.UserCreatedEvent.Builder();
    } else {
      return new com.microservice.user_service.event.UserCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.microservice.user_service.event.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.microservice.user_service.event.UserCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.user_service.event.UserCreatedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.user_service.event.UserCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.user_service.event.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservice.user_service.event.UserCreatedEvent.Builder clearEmail() {
      email = null;
